...
echo "→ Rasterising PNG sizes from $SRC using ImageMagick…"

for SIZE in 16 32 64 128 256 512; do
  convert -background none -size "${SIZE}x${SIZE}" "$SRC" "$OUT/${SIZE}x${SIZE}.png"
  echo "  ✔ ${SIZE}x${SIZE}.png"
done

# @2x (Retina)
convert -background none -size "256x256" "$SRC" "$OUT/128x128@2x.png"
echo "  ✔ 128x128@2x.png"
